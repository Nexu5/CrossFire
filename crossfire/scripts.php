...
$filename = "/var/www/crossfire/scripts/cleanup.sh";
...
$filename = "/var/www/crossfire/ssh/ssh-keepalive.sh";
  $fh = fopen($filename, "r") or die("Could not open file!");
  $data = fread($fh, filesize($filename)) or die("Could not read file!");
  fclose($fh);
...
$filename = "/var/www/crossfire/3g/3g-keepalive.sh";
  $fh = fopen($filename, "r") or die("Could not open file!");
  $data = fread($fh, filesize($filename)) or die("Could not read file!");
  fclose($fh);
...
$filename = "/var/www/crossfire/scripts/user.sh";
  $fh = fopen($filename, "r") or die("Could not open file!");
  $data = fread($fh, filesize($filename)) or die("Could not read file!");
  fclose($fh);
